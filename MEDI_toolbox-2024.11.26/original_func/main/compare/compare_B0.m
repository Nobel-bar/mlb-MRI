%================================================================
% B0map 結果 確認用プログラム (マスク収縮版)
%================================================================

%% --- 1. データ読み込み ---
path_mat_GE_Mag   = "F:\hamaguchi\20251204\2DGE\3_output_data\Mask.mat";
path_mat_GE_B0 = "F:\hamaguchi\20251204\2DSE\3_output_data\B0_Map_Result.mat";
path_mat_SE_Mag   = "F:\hamaguchi\20251204\2DSE\3_output_data\Mask.mat";
path_mat_SE_B0 = "F:\hamaguchi\20251204\2DSE\3_output_data\B0_Map_Result.mat";
...
[img_mag_GE, img_mask_GE, img_freq_GE] = load_mat_data(path_mat_GE_Mag, path_mat_GE_B0);
[img_mag_SE, img_mask_SE, img_freq_SE] = load_mat_data(path_mat_SE_Mag, path_mat_SE_B0);
