...
%         end
        ...
        % ★高速化シミュレーション関数呼び出し
        k_line_signal = simulate_kx_line_fast(img_slice, kx_val, ky_collect_indices);
...
% =========================================================
% ★★★ 行列演算版シミュレーション関数 (方向修正版backをけした) ★★★
% =========================================================
function k_space_line_signal = simulate_kx_line_fast(image_data, kx_row_index, ky_col_indices)
